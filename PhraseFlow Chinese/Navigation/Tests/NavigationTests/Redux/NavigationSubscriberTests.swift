//
//  NavigationSubscriberTests.swift
//  Navigation
//
...
@MainActor
final class NavigationSubscriberTests {
    var mockEnvironment: MockNavigationEnvironment!
    var mockStore: MockStore<NavigationState, NavigationAction, NavigationEnvironmentProtocol>!
    ...
    func test_storeObserves_allValues_removeDuplicate() async {
        ...
        let duplicateAction = NavigationAction.refreshAppSettings(.arrange)
    ...
    func assertDispatchedActions(
        _ expectedActions: [NavigationAction],
        afterSetup setup: () -> Void = { /* no need to implementation */ },
        timeout: TimeInterval = 3.0,
        function: String = #function
    ) async {
        var actual = [NavigationAction]()
        ...
        await withCheckedContinuation { continuation in
             ...
             */
            navigationSubscriber(mockStore, mockEnvironment)
    ...
    func expectedActions_allValues() -> [NavigationAction] {
        // Expected values
