...
// MARK: - StudySubscriberTests

@MainActor
final class StudySubscriberTests {
    var mockEnvironment: MockStudyEnvironment!
    var mockStore: MockStore<StudyState, StudyAction, StudyEnvironmentProtocol>!
    ...
    func test_storeObserves_allValues_removeDuplicate() async {
        ...
        let duplicateAction = StudyAction.refreshAppSettings(.arrange)
    ...
    func assertDispatchedActions(
        ...
        await withCheckedContinuation { continuation in
             ...
             */
            studySubscriber(mockStore, mockEnvironment)
    ...
    func expectedActions_allValues() -> [StudyAction] {
        // Expected values
