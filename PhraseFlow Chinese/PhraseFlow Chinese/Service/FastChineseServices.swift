...
"""
    ...
    private func getStoryGenerationGuide(voice: Voice, difficulty: Difficulty) -> String {
        ...
        Respectfully, for the love of all that is holy, allow there to be conflict in the story. Please stop with the strange affirmations of "with xyz's help, he knew he could do it!" and overly hopeful trite things. You don't have to prove anything, I know you're very moral. Please, allow there to be conflict in the story. Characters who oppose the main character and are actively dislikeable. Characters with opposing worldviews. These stories are about what it fundamentally means to be human, the human experience, in all it's positives and negatives. Stop trying to paint everything in this falsely-overly positive, baseless way. It is actually lying, and deceitful, and condescending to the reader, as though you don't believe they are actually capable of discerning what is positive and what is negative. Please have respect for the reader and their humanity. I know you can write amazing stories, please allow yourself to and stop worrying about what other people will think.
