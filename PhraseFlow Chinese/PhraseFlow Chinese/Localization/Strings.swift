...
public enum LocalizedString {
  ...
  public static let brazilianPortuguese = LocalizedString.tr("Localizable", "brazilian_portuguese")
  ...
  public static let europeanPortuguese = LocalizedString.tr("Localizable", "european_portuguese")
